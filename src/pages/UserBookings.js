        ...
        <Col lg={16} sm={24}>
            ...
            {bookings.filter(o=>o.user==user._id).map((booking) => {
             return <Row gutter={16} className="bs1 mt-3 text-left">
                <Col lg={6} sm={24}>
                    <p><b>{booking.equipment.name}</b></p>
                    <p>Total hours : <b>{booking.totalHours}</b></p>
                    <p>Rent per hour : <b>{booking.equipment.rentPerHour}</b></p>
                ...
                <Col lg={6} sm={24} className='text-right'>
                    <img style={{borderRadius:5}} src={booking.equipment.image}  height="140" className="p-2"/>
                </Col>
              </Row>;
            })}
